...
class S4TaxTrackingScreen extends StatefulWidget {
  const S4TaxTrackingScreen({super.key});

  @override
  State<S4TaxTrackingScreen> createState() => _S4TaxTrackingScreenState();
}

class _S4TaxTrackingScreenState extends State<S4TaxTrackingScreen> {
  DateTime fromDate = DateTime(2025, 1, 1);
  DateTime toDate = DateTime(2025, 1, 31);
  final List<TaxEntry> data = TaxEntry.getMockData();
            ...
            rows: data.map((entry) {
              return DataRow2(
                cells: [
                  ...
                  DataCell(
                    Text(
                      NumberFormatter.formatCurrency(entry.taxAmount),
                      style: TextStyle(
                        fontWeight: FontWeight.bold,
                        color: theme.colorScheme.primary,
                      ),
